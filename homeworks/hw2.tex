...
\begin{itemize}
    ...
    [Hint: use the fact that the gradient of the nuclear norm of a matrix $X$ is equal to $U V^{\top}$, where $X = U D V^{\top}$ is the singular value decomposition of a matrix $X$.]
\end{itemize}
