...
When the MDP is known, solving the optimal policy can be achieved in polynomial time using constrained optimization \citep{lan2023policy}.

An important concept here for evaluating the value function is called the \emph{Value Iteration}, an iterative method to compute the optimal value function $V^{\star}$.
