...
The feature map under the NTK is given by $\big[\frac{a_1 \sigma'(w_1(0)^{\top} x_i)}{\sqrt m} x_i, \dots, \frac{a_m \sigma'(w_m(0)^{\top} x_i)}{\sqrt m} x_i\big]$, for every $i = 1, 2, \dots, n$.
\end{example}
